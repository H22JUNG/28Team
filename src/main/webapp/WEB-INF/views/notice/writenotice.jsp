...
<body>
	...
	<form action="${pageContext.request.contextPath}/insertNotice" method="post" id="update-form">
		<main>
			<div class="container">
				<div class="head">
					<h1>공지사항</h1>
				...
				<div class="content-box">
					...
					<div class="content">
						...
						<div id="contentDiv" onkeydown="resize()" onkeyup="resize()" contenteditable="true"></div>
